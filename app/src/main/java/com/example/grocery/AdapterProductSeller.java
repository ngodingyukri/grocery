...
public class AdapterProductSeller extends RecyclerView.Adapter<AdapterProductSeller.HolderProductSeller> implements Filterable {
    ...
    public void onBindViewHolder(@NonNull HolderProductSeller holder, int position) {
        ...
        try
        {
            Picasso.get().load(icon).placeholder(R.drawable.ic_add_shoping_primary).into(holder.productIconIv);
        }
        catch (Exception e)
        {
            holder.productIconIv.setImageResource(R.drawable.ic_add_shoping_primary);
        }
    ...
    private void detailBottomSheet(ModelProduct modelProduct) {
        ...
        try
        {
            Picasso.get().load(icon).placeholder(R.drawable.ic_add_shoping_primary).into(productIconIv);
        }
        catch (Exception e)
        {
            productIconIv.setImageResource(R.drawable.ic_add_shoping_primary);
        }
        ...
        editBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                //open edit product acitivity, pass id of product
        ...
        deleteBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                builder.setTitle("Delete")
                        .setMessage("Are you sure yo want to delete product" +title+ "  ?")
    ...
    class HolderProductSeller extends RecyclerView.ViewHolder{
        ...
        private TextView discountedNoteTv,titleTv,quantitiyTv,discountedPriceTv,originalPriceTv;
        public HolderProductSeller(@NonNull View itemView) {
            ...
            quantitiyTv = itemView.findViewById(R.id.quantitiyTv);
